...
{
  public interface IDeleteStatement<TEntity> : ISqlStatement<int>, IClauseBuilder where TEntity : class, new()
  {
    ...
    IDeleteStatement<TEntity> WhereIn<T, TMember>(Expression<Func<T, TMember>> selector, TMember[] values);
  }
}
