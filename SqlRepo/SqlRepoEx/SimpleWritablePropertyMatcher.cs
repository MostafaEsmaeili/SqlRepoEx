...
namespace SqlRepoEx
{
  public class SimpleWritablePropertyMatcher : IWritablePropertyMatcher
  {
    private readonly Type[] additionalTypes;

    public SimpleWritablePropertyMatcher()
    {
    ...
    {
      return Test(propertyInfo.PropertyType) && !propertyInfo.IsNonDBField();
    }
  }
}
